...
export default function MonthEndModal({ visible, data }: { visible: boolean; data: any }) {
  ...
  const insights = useMemo(() => {
    ...
    const overshootInsight = { id: 'overshoot', title: 'Overshoot', value: 'None', sub: 'Safe zone', score: 0, eligible: false, icon: AlertCircle, color: colors.danger };
    const damageInsight = { id: 'damage', title: 'Day Damage', value: '0%', sub: 'No spikes', score: 0, eligible: false, icon: AlertCircle, color: colors.purple };
    const freqInsight = { id: 'frequency', title: 'Habit Alert', value: '0x', sub: 'None', score: 0, eligible: false, icon: CheckCircle2, color: colors.accent };
