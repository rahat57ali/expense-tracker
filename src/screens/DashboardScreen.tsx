...
const styles = StyleSheet.create({
  ...
  kpiLabel: { color: '#D1D1D1', fontSize: 9, fontFamily: 'Inter_700Bold', letterSpacing: 1, marginBottom: 8 },
  kpiValueRow: { flexDirection: 'row', alignItems: 'baseline', gap: 4, marginTop: 4 },
  kpiValueStack: { marginTop: 4 },
  kpiCurrency: { color: '#949494', fontSize: 10, fontFamily: 'Inter_500Medium' },
  kpiCurrencySmall: { color: '#949494', fontSize: 8, fontFamily: 'Inter_700Bold', marginBottom: 2 },
  ...
  catCardName: { color: '#D1D1D1', fontFamily: 'Inter_700Bold', fontSize: 10, textTransform: 'uppercase' },
  catRemaining: { color: '#FFFFFF', fontFamily: 'Outfit_600SemiBold', fontSize: 18 },
  catRemainingLabel: { color: '#949494', fontFamily: 'Inter_700Bold', fontSize: 9, letterSpacing: 0.5 },
  ...
  expenseCat: { color: '#D1D1D1', fontFamily: 'Inter_500Medium', fontSize: 10, textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
  ...
  listDate: { color: '#D1D1D1', fontFamily: 'Inter_500Medium', fontSize: 10, marginTop: 2 },
});
