...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, fontFamily: 'Inter_500Medium', color: '#949494', marginTop: 4 },
  headerRight: { flexDirection: 'row', alignItems: 'center', gap: 16 },
  summaryBox: { alignItems: 'flex-end', paddingRight: 4 },
  summaryLabel: { color: '#949494', fontSize: 8, fontFamily: 'Inter_700Bold', letterSpacing: 1.5 },
  ...
  emptySub: { color: '#949494', fontSize: 14, fontFamily: 'Inter_400Regular', textAlign: 'center', lineHeight: 20 },
  ...
  billDate: { color: '#D1D1D1', fontSize: 10, fontFamily: 'Inter_500Medium', marginTop: 2 },
  ...
  suggestionsTitle: { color: '#D1D1D1', fontSize: 10, fontFamily: 'Inter_700Bold', letterSpacing: 1.5 },
  ...
  suggestionName: { color: '#949494', fontSize: 10, fontFamily: 'Inter_500Medium', textAlign: 'center' },
  ...
  label: { color: '#D1D1D1', fontSize: 10, fontFamily: 'Inter_700Bold', letterSpacing: 1.5, marginBottom: 8 },
